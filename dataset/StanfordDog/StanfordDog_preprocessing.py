...
data_dir = '/home/chenhaoxing/MANet/datasets/StanfordDog'                # the path of the download dataset
save_dir = '/home/chenhaoxing/MANet/datasets/StanfordDog'    # the saving path of the divided dataset
