...
data_dir = '/home/chenhaoxing/MANet/datasets/StanfordCar'                # the path of the download dataset
save_dir = '/home/chenhaoxing/MANet/datasets/StanfordCar'    # the saving path of the divided dataset
