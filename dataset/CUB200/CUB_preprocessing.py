...
data_dir = '/home/chenhaoxing/MANet/datasets/CUB'              # the path of the download dataset
save_dir = '/home/chenhaoxing/MANet/datasets/CUB'  # the saving path of the divided dataset
